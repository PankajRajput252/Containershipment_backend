...
public interface SupportTicketRepository extends JpaRepository<SupportTicket, Integer> {
    ...
    List<SupportTicket> findByUserNodeId(String inputFkId, Pageable pageable);

    SupportTicket findBySupportTicketPkId(Integer inputPkId);

    Long countBySupportTicketPkId(Integer inputPkId);

    Long countByUserNodeId(String inputFkId);
}
